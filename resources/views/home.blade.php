<x-layout>
    <x-slot:title>Página Principal</x-slot>
        ...
        <div class="container mt-1 d-flex flex-column align-items-center justify-content-center bg-white p-5 full-height-container">
            ...
            <!-- Logo de la marca -->
            <div class="mb-4">
                <img src="{{ asset('images/marca-final.png') }}" alt="Logo Refood" class="img-fluid rounded logo-image">
            </div>

            <h1 class="text-center text-muted mb-5">Somos una comunidad de concientización alimentaria.
                <br>Rescatamos alimentos excedentes y los entregamos <br>a comedores comunitarios.
            </h1>
